...
var createReactComponentClass = require(
  "app/util/create-react-component-class"
);
var KeyboardNav = require("../keyboard-nav");
var keyboardNavCfg = require(
  "./final-jeopardy-keyboard-nav"
);
var PlayerModel = require("app/model/player");
...
const Player = class Player extends React.Component {
  constructor (props) {
    super(props);
          ...
          <table className="players-table">
            ...
            <tbody className="players">
              {props.players.concat(tvPlayers).map((player, i) => {
                var model = PlayerModel(player, {index: i});
                return <Player
                  {...player} id={i} key={i}
...
FinalJeopardy.propTypes = {
  num_tv_players: PropTypes.number.isRequired,
  players: PropTypes.arrayOf(PropTypes.object).isRequired,
  sanitizeScore: PropTypes.func.isRequired,
